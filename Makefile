...
tzdriver-objs += core/teek_client_api.o
...
EXTRA_CFLAGS += -DCONFIG_CPU_AFF_NR=0 -DCONFIG_BIG_SESSION=100 -DCONFIG_NOTIFY_PAGE_ORDER=4 -DCONFIG_512K_LOG_PAGES_MEM
...
EXTRA_CFLAGS += -DMAILBOX_POOL_COUNT=32 -DLATE_KILL_WHEN_TA_LOAD
ifeq ($(CROSS_DOMAIN_PERF), y)
EXTRA_CFLAGS += -DCROSS_DOMAIN_PERF
endif
ifeq ($(CPU_GROUP_BINDING), y)
EXTRA_CFLAGS += -DCONFIG_CPU_GROUP_BINDING -DCONFIG_NUM_DIE=4 -DCONFIG_NUM_PHY_CORE_PER_DIE=40 -DCONFIG_NUM_TEE_PHY_CORE_PER_DIE=32 -DCONFIG_MAX_TEE_CORE=128
endif
